...
public class GameActivity extends AppCompatActivity {
    ...
    private void loadDataToViews(){
        ...
        buttons[emptyX][emptyY].setBackgroundColor(ContextCompat.getColor(this,R.color.Colorfree));
    }
    ...
    public void buttonClick(View view){
        ...
        if ((Math.abs(emptyX-x)==1&&emptyY==y)||(Math.abs(emptyY-y)==1&&emptyX==x)){
            ...
            button.setText("");
            button.setBackgroundColor(ContextCompat.getColor(this, R.color.Colorfree));
            emptyX = x;
            emptyY = y;
            checkWin();
        }
    ...
    private void checkWin() {
        ...
        if (isWin) {
            ...
            for (int i = 0; i < group.getChildCount(); i++) {
                buttons[1/4][1%4].setClickable(false);
            }
